    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        */
        ...
        if (world.isClient) {
            ...
            List<BlockPos> transporters = ModBlocks.getBlocksInVicinityByType(world, pos, 128, state);
            ...
            // teleport to the nearest transporter TODO: change this to linked transporter
            for (int i = 0; i < transporters.size(); i++) {
